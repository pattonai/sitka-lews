...
#calculate antecedent conditions prior to day d
id.logit$precip_mm_day_shift = lag(id.logit$precip_mm_day,n=1)
id.logit$precip_mm_2day_shift = lag(id.logit$precip_mm_2day,n=1)
id.logit$precip_mm_3day_shift = lag(id.logit$precip_mm_3day,n=1)
id.logit$precip_mm_7day_shift = lag(id.logit$precip_mm_7day,n=1)
id.logit$precip_mm_14day_shift = lag(id.logit$precip_mm_14day,n=1)
